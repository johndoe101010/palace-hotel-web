...
const Hero = () => {
  return (
    <section className="relative h-[calc(100vh-96px)] min-h-[620px] md:h-[calc(100vh-112px)] w-full overflow-hidden">
      ...
      <div className="relative h-full container-luxe flex flex-col justify-end pb-20 md:pb-24">
        <motion.div
        ...
        >
          ...
          <p className="text-base md:text-lg text-foreground/70 max-w-xl leading-relaxed mb-10 font-light">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="#suites" className="btn-ghost-gold">Ver habitaciones</a>
          </div>
        </motion.div>
      </div>
